...
def run_app():
    ...
    print("Running - Q to quit | BACKSPACE to delete | SPACE to add current word")
        ...
        while True:
            ...
            if letter and conf >= CONF_THRESHOLD:
                ...
                if letter == cur_letter:
                    ...
                    if held >= SAME_LETTER_SECS and not confirmed:
                        word += letter
                        confirmed = True
                        logging.info(f"Confirmed letter: {letter}")
                else:
                    cur_letter = letter
                    letter_start = now
                    confirmed = False
            ...
            if letter and conf >= CONF_THRESHOLD:
                ...
                cv2.rectangle(
                    ...
                    (30, h - 60),
                    (30 + bar_w, h - 38),
                    (0, 255, 150) if not confirmed else (255, 200, 0),
                    -1,
                )
    ...
    logging.info(f"Final sentence: {final}")
